...
<table id="myTable"  class="table table-striped table-bordered" >
	...
	<tbody>
	<?php
	$sql ="SELECT * FROM employee WHERE emptype IN('Principal','Professor','HOD','Lecturer','Librarian','Computer Instructor','Lab Assistant','Office Peon','Security Man','Cleaner','Others')";
	$qsql = mysqli_query($con,$sql);
	...
	else
	{
		...
		echo "</td>
				...
				<td>$rs[empcode]</td>
				<td>$rs[status]</td>
				<td style='width: 100px;'> <a href='employee.php?editid=$rs[0]' class='btn btn-info' style='width: 100px;'>Edit</a><br><a href='viewemployee.php?delid=$rs[0]' onclick='return validatedel()'  class='btn btn-danger'  style='width: 100px;'>Delete</a></td>
			</tr>";
	}
	 ?>
	</tbody>
